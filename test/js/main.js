...
/* harmony import */ var _components_lazyload_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/lazyload.min.js */ "./src/js/components/lazyload.min.js");
/* harmony import */ var _components_lazyload_min_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_lazyload_min_js__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _components_services_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_services_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _components_svg_fill_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/svg-fill.js */ "./src/js/components/svg-fill.js");
/* harmony import */ var _components_svg_fill_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_svg_fill_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _components_portfolio_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/portfolio.js */ "./src/js/components/portfolio.js");
...
/* harmony import */ var _components_modal_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_modal_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _components_quiz_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/quiz.js */ "./src/js/components/quiz.js");
/* harmony import */ var _components_quiz_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_quiz_js__WEBPACK_IMPORTED_MODULE_6__);
...
/***/ "./src/js/components/lazyload.min.js":
/*!*******************************************!*\
  !*** ./src/js/components/lazyload.min.js ***!
  \*******************************************/
...
/* function check_radio_selected(error_message) {
	obj = $('.wpcf7-list-item label.checked');
...
function check_radio_selected(elem_id) {
  obj = $('.wpcf7-form-control-wrap[data-name="' + elem_id + '"]');
  /* obj = $('.wpcf7-form-control-wrap[data-name="' + elem_id + '" .wpcf7-form-control .wpcf7-list-item label.checked'); */

  if (!(obj.length && obj.find('label.checked'))) {
    /* $('.wpcf7-form-control-wrap[data-name="' + elem_id + '" .wpcf7-form-control .wpcf7-list-item label.checked').append('<span class="wpcf7-not-valid-tip" aria-hidden="true">Это поле обязательное для заполнения</span>'); */
...
function check_input_value(elem_id) {
  ...
  if (obj.length && obj.val() == "") {
    $('.wpcf7-form-control-wrap[data-name="' + elem_id + '"').append('<span class="wpcf7-not-valid-tip" aria-hidden="true">Это поле обязательное для заполнения</span>');
    return false;
  }
...
(function ($) {
  ...
  function _formSend() {
    _formSend = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              form__quiz.classList.add('_sending');
            ...
            case 8:
              ...
              form.reset();
              to_step(6, true);
              $("#quiz_form").classList.remove('_sending');
              _context.next = 17;
              break;
