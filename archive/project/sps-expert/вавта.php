...
<div class="container">
			...
			if ( $loop->have_posts() ) {
				while ( $loop->have_posts() ) : $loop->the_post();?>
					...
					<div class="job_item">
						<p class="jobs_title"><?php the_field('news__title') ?></p>
						<p class="jobs_descript"><?php the_field('news__description') ?></p>
						<p class="jobs_descript_full"><?php the_field('news__more__description') ?></p>
