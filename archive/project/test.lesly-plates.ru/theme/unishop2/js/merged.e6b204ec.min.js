...
c.removeDiacritcs(a));return a.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,"\\$&")});if(0===a.length)return this;d=b.caseSensitive?"":"i";a="("+a.join("|")+")";b.wordsOnly&&(a=(b.wordsBoundaryStart||b.wordsBoundary)+a+(b.wordsBoundaryEnd||b.wordsBoundary));var f=new RegExp(a,d);return this.each(function(){c.highlight(this,f,b.element,b.className,e,b.ignoreDiacritics)})}});$(function(){
